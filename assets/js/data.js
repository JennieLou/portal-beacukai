const AppData = {
  ...
  authorizations: [
  { name: "CEISA Submission", access: "Add / View" },
  ...[
    "Pemasukan Barang",
    "Pengeluaran Barang",
  ...
  reports: {
    ...
    mutasiBahanBaku: [
      ["1", "RM-FAB-001", "Fabric Cotton Twill", "MTR", "4,000", "1,250", "1,700", "0", "3,550", "3,550", "0", "Sesuai"],
    ...
    mutasiBarangJadi: [
      ...
      ["2", "FG-PANT-220", "Chino Pants Khaki", "PCS", "870", "420", "320", "0", "970", "970", "0", "Sesuai"],
    ...
    mutasiScrap: [
      ...
      ["2", "SC-PACK-002", "Scrap Carton", "KG", "95", "18", "30", "0", "83", "80", "0", "Sesuai"]
    ],
    posisiWip: [
      ["1", "WIP-260501-01", "SF-CUT-030", "Cut Panel Set", "SET", "700", "Sesuai"],
      ["2", "WIP-260503-02", "SF-SEW-044", "Sewing Assembly", "PCS", "360", "Sesuai"],
      ["3", "WIP-260508-03", "SF-WASH-011", "Garment Washing Batch", "BATCH", "12", "Sesuai"]
    ],
    mutasiBarangModal: [
      ["1", "AST-SEW-100", "High Speed Sewing Machine", "UNIT", "24", "0", "0", "0", "24", "24", "0", "Sesuai"],
      ["2", "AST-CUT-020", "Auto Cutting Machine", "UNIT", "2", "1", "0", "0", "3", "3", "0", "Sesuai"],
      ["3", "OTH-RACK-018", "Storage Rack Heavy Duty", "UNIT", "80", "0", "4", "0", "76", "76", "0", "Sesuai"]
    ],
    logHistoryUser: [
      ["1", "2026-05-13 08:02:11", "BC-USER-01", "Bea Cukai User", "Login Success"],
      ["2", "2026-05-13 08:45:19", "BC-USER-01", "Bea Cukai User", "Login Success"],
      ["3", "2026-05-12 17:14:02", "BC-USER-02", "Supervisor BC", "Login Success"],
      ["4", "2026-05-12 07:58:43", "BC-USER-03", "Audit BC", "Login Success"]
    ]
  },
  modalRows: {
    pemasukan: [
...
AppData.ceisa = {
  submissions: [
    {
      ...
      remarks: "Keterangan untuk dokumen ini.",
  ...
  eligibleDocuments: [
    { bcType: "BC 2.5",documentType: "Pemasukan", docNo: "GRPO-260701", postingDate: "2026-05-10", businessPartner: "PT Benang Prima Textile", warehouse: "JP-MT002", totalQty: "2,400", totalAmount: "124,500,000", currency: "IDR", remarks: "Keterangan untuk dokumen ini.", valid: true },
    { bcType: "BC 2.3",documentType: "Pemasukan", docNo: "GRPO-260702", postingDate: "2026-05-11", businessPartner: "PT Kimia Tekstil Jaya", warehouse: "JP-MT002", totalQty: "520", totalAmount: "68,250,000", currency: "IDR", remarks: "Keterangan untuk dokumen ini.", valid: false, error: "Missing HS Code" },
    { bcType: "BC 4.1",documentType: "Pengeluaran", docNo: "DLV-260711", postingDate: "2026-05-11", businessPartner: "PT Retail Sandang Indonesia", warehouse: "JP-FG002", totalQty: "360", totalAmount: "97,200,000", currency: "IDR", remarks: "Keterangan untuk dokumen ini.", valid: true },
    { bcType: "BC 2.7",documentType: "Pengeluaran", docNo: "DLV-260712", postingDate: "2026-05-12", businessPartner: "CV Nusantara Distribusi", warehouse: "JP-FG002", totalQty: "180", totalAmount: "49,500,000", currency: "IDR", remarks: "Keterangan untuk dokumen ini.", valid: false, error: "Invalid NPWP" },
    { bcType: "BC 2.5",documentType: "Pemasukan", docNo: "TRF-260715", postingDate: "2026-05-12", businessPartner: "Kawasan Berikat Mitra", warehouse: "JP-SF002", totalQty: "700", totalAmount: "31,500,000", currency: "IDR", remarks: "Keterangan untuk dokumen ini.", valid: false, error: "Invalid document mapping" }
  ],
  sapItems: [
